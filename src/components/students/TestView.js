      ...
      <div className={style}>
        <div className="flex-column">
          ...
          <div className="main-wrapper test-instruction">
            ...
            <p>
              1. Click on Start Exam bocum of your screen to begin examination.
            </p>
            <p>
              2. The clock has been set at server and count down tomer at the
              top right side of the screen will display left out time so closure
              from where you can monitor time you have to complete the exam
            </p>
            <p>3. Click on Next Button for next question</p>
            <p>
              4. The colour coded diagram on the right side of the screen shows
            ...
            <p>
              5: All the answered questions will be counted for calculating the
              firial score
            </p>
            <p>
              8. Do not dick End Exam Button before completing the examination.
              In case you click End Exam burzon you will not be permined to
              continue
            </p>
          </div>
